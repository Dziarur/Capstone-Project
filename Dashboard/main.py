...
halaman_quiz = st.Page('quiz_proto.py', title='Quiz Proto')
main_page = st.Page(main, title='Main Page')

pg = st.navigation([main_page, halaman_quiz], position="sidebar",expanded=True, )
pg.run()